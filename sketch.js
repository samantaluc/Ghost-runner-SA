   ...
   if (gameState === "play") {
      ...
      // escreva o código para mover para a esquerda quando a tecla para a esquerda for pressionada
       ...
       if(keyDown("right_arrow")){
            ghost.x = ghost.x + 3; // escreva o código para mover para a direita quando a tecla para a direita for pressionada
        }
       if(keyDown("space")){
          ghost.velocityY = -10;// escreva o código para mover para cima quando a tecla espaço for pressionado
        }
